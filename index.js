...
app.get("/", async (req, res) => {
  ...
  // Here I am finding all labels available on the current Gmail
  const response = await gmail.users.labels.list({
    userId: "me",
  });

  // This function is finding all the email that have unreplied or unseen
  ...
  async function main() {
    ...
    setInterval(async () => {
      ...
      // Here I am checking if there is any Gmail that did not get a reply
              ...
              resource: {
                raw: Buffer.from(
                  `To: ${
                    ...
                    `Thanks for your email. I'm Currently on vacation and will reply to you when I return\r\n`
                ).toString("base64"),
              },
            };
